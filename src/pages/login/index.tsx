					...
					<Card.Body>
						<Row style={{ minHeight: '50vh' }}>
							...
							>
								...
								<Container className="d-flex align-items-center justify-content-center mb-3 border-bottom p-3">
									{providers &&
											...
											provider.name !== 'Credentials' ? (
												<div className="p-1 mb-2" key={provider.name}>
													<Button
														...
														variant={
															provider.name === '42 School' ? 'primary' : 'dark'
														}
														onClick={() =>
															signIn(provider.id, {
																callbackUrl: 'http://localhost:3000/home',
													...
													>
														<span className="me-2">Sign up with </span>
